...
class Main extends React.Component {
    ...
    render() {
      ...
      return (
        <div className="App">
          <h1 className="display-4 my-4 text-center text-muted">Wiki Search</h1>
          <div className="row justify-content-center mb-4">
          <form class="form-inline" action="">
            <input id='myTest' className="form-control" type="text" value={this.state.WikiSearchTerms || ''} onChange={this.changeWikiSearchTerms} onInput={this.useWikiSearchEngine} onFocus={this.useWikiSearchEngine} onClick={this.useWikiSearchEngine} placeholder='Search Wikipedia Articles' />
            
            {/* <button className="btn btn-primary mr-2" type='submit' onClick={this.useWikiSearchEngine}>Search</button> */}
          </form>
          </div>
